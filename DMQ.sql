-- ------ Filters ------ --
-- Movies:
SELECT movie_id, name, release_date, out_of_theater_date, rating FROM Movies WHERE name = :mov_name_from_webpage

-- Auditoriums:
-- filter by auditoriums.name
SELECT auditorium_id, Auditoriums.name AS auditorium_name, number_of_seats, Theaters.name AS theaters_name, Projector_Equipments.type AS projector_equipments_type 
FROM Auditoriums 
...
WHERE Auditoriums.name = :aud_aud_name_from_webpage
...
FROM
	Tickets 
WHERE
	name = : ticket_name_from_webpage -- Customers:
...
FROM
	Customers 
WHERE
	name = : customer_name_from_webpage -- Projector_Equipments:
-- filter the projectors by its type
SELECT
	projector_equipments_id,
	type 
FROM
...
-- Auditoriums:
-- INSERT
INSERT INTO Auditoriums(name, number_of_seats, theater_id, projector_equipments_id) VALUES(
 :aud_input_name,
...
projector_equipments_id = :aud_edit_projectorID
WHERE
...
-- Tickets:
-- INSERT
INSERT INTO Tickets(movie_auditorium_id, customer_id, seat, time)VALUES(
...
-- DELETE
DELETE FROM Theaters WHERE theaters_id = :thea_ID_from_the_delete_row
